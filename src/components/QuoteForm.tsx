  ...
  return (
    <div className="bg-card rounded-lg shadow-2xl p-8 w-full max-w-md" id="contact">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <a href="tel:4783912675" className="flex items-center justify-center gap-2 text-sm text-muted-foreground hover:text-accent transition-colors">
          Prefer to talk? <Phone className="w-3.5 h-3.5 text-accent" /> <span className="text-accent font-bold">786-482-1573</span>
        </a>
