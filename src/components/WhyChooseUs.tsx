...
const features = [
  ...
  { icon: MapPin, title: "Locally Owned", desc: "Based in Griffin/Riverdale, GA. We live and work in the community we serve — our reputation depends on every job." },
];
  ...
  <section id="why-us" className="py-20 bg-surface-gray">
    <div className="container mx-auto px-4">
      <div className="text-center mb-14">
        ...
        <h2 className="font-display font-800 text-3xl md:text-4xl text-foreground mt-3">The Stevie Marshall Difference</h2>
