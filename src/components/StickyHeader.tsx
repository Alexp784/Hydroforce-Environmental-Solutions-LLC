    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-surface-dark/95 backdrop-blur-sm border-b border-surface-dark">
      <div className="container mx-auto flex items-center justify-between py-3 px-4">
        <a href="#" className="flex items-center gap-3">
          <img src={mpsLogo} alt="Hydroforce Environmental LLC logo" className="h-12 w-auto" />
          <div className="flex flex-col">
            <span className="font-display font-bold text-lg text-accent leading-tight">Hydroforce Environmental LLC</span>
            <span className="font-body text-xs text-accent-foreground">Waste Removal • Recycling • Storm Cleanup</span>
          </div>
        </a>
        ...
        <div className="flex items-center gap-4">
          <a href="tel:7864821573" className="hidden sm:flex items-center gap-2 text-accent font-display font-bold text-sm">
